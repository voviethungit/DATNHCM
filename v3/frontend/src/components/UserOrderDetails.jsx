  ...
  return (
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      <div className="w-full flex items-center justify-between pt-6">
        ...
        <h5 className="text-[#00000084]">
          Đặt vào lúc: <span>{data?.createdAt?.slice(0, 10)}</span>
        </h5>
      </div>
          ...
          <div className="w-[50%] h-min bg-[#fff] shadow rounded-md p-3">
            ...
            <div className="w-full ml-3">
              ...
              <textarea
                ...
                placeholder="Sản phẩm của bạn thế nào? Hãy viết cảm nhận của bạn về nó!"
      ...
      <div className="border-t w-full text-right">
        <h5 className="pt-3 text-[18px]">
          Tổng giá: <strong>{formatCurrency(data?.totalPrice)}</strong>
        </h5>
      </div>
      <br />
      <br />
      <div className="w-full 800px:flex items-center">
        <div className="w-full 800px:w-[60%]">
          ...
          <h4 className="pt-3 text-[20px]">
            Số điện thoại: 0{data?.shippingAddress.phoneNumber}
          </h4>
          <h4 className="pt-3 text-[20px]">
            Địa chỉ: {data?.shippingAddress.address1}
          </h4>
          <h4 className="pt-3 text-[20px]">
            Ghi Chú: {data?.shippingAddress.address2}
          </h4>
          <h4 className="pt-3 text-[20px]">
            Tỉnh/Thành Phố: {data?.shippingAddress.province}
          </h4>
          <h4 className="pt-3 text-[20px]">
            Quận/Huyện: {data?.shippingAddress.district}
          </h4>
          <h4 className="pt-3 text-[20px]">
            Phường/Xã: {data?.shippingAddress.ward}
          </h4>
        </div>
        <div className="w-full 800px:w-[40%]">
          <h4 className="pt-3 text-[20px]">Thông tin thanh toán:</h4>
          <h4>Trạng thái: {data?.paymentInfo.status ? data?.paymentInfo.status : "Chưa thanh toán"}</h4>
        </div>
      </div>  
      <br />
      <br />
