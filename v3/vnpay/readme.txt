...
5. Chạy ứng dụng: npm start app.js. Ứng dụng sẽ start ở port 8888.http://localhost:8888/order/create_payment_url
6. Mở trình duyệt và truy cập vào địa chỉ:  để bắt đầu chạy demo
